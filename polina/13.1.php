...
<div class="rrt">
    <p class="tyty">Любовные романы</p>
    <ol>
        <li>Любовь со смертью</li>
        <p>Гусейнова Ольга</p>
        <a href="27.php" class="opi" onclick="showNotification(event)">Читать</a>
        <br>
        <li>Искупление</li>
        <p>Иэен Макьюэн</p>
        <a href="29.php" class="opi" onclick="showNotification(event)">Читать</a>
        <br>
        <li>Внутри убийцы</li>
        <p>Майк Омер</p>
        <a href="24.php" class="opi" onclick="showNotification(event)">Читать</a>
    </ol>
    <br>
</div>
