...
<div class="rrt">
    <p class="tyty">Саморазвитие</p>
    <ol>
        <li>К себе нежно</li>
        <p>Ольга Примаченко</p>
        <a href="30.php" class="opi" onclick="showNotification(event)">Читать</a>
        <br>
        <li>Теория невероятности</li>
        <p>Татьяна Мужицкая</p>
        <a href="31.php" class="opi" onclick="showNotification(event)">Читать</a>
        <br>
        <li>Трать</li>
        <p>Билл Перкинс</p>
        <a href="32.php" class="opi" onclick="showNotification(event)">Читать</a>
        <br>
        <li>Ты можешь</li>
        <p>Билл Перкинс</p>
        <a href="33.php" class="opi" onclick="showNotification(event)">Читать</a>
    </ol>
    <br>
</div>
