...
<div class="rrt">
    <p class="tyty">Фантстика</p>
    <ol>
        <li>Разведчик барона</li>
        <p>Макс Глебов</p>
        <a href="25.php" class="opi" >Читать</a>
        <br>
        <li>Точка</li>
        <p>Кира Уайт</p>
        <a href="26.php" class="opi" >Читать</a>
        <br>
        <li>Любовь со смертью</li>
        <p>Гусейнова Ольга</p>
        <a href="27.php" class="opi" >Читать</a>
        <br>
        <li>Спектор</li>
        <p>Сергей Лукьяненко</p>
        <a href="28.php" class="opi" >Читать</a>
    </ol>
    <br>
</div>
