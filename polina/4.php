...
function showSuperModal() {
    var email = document.getElementById('email').value; // Получаем значение введенной почты
    ...
    document.getElementById('superModal').innerHTML = modalContent; // Отображаем введенную почту в модальном окне с цветом #5B5959 и размером 20px
    document.getElementById('superModal').style.display = 'block'; // Отображаем модальное окно
}


function openIndexPage() {
    alert('С возвращением'); // Выводим уведомление с надписью "С возвращением"
...
<center><p class="zz">При входе на ресурс вы принимаете  <span class="zzz">публичную </span></p></center>
        ...
        <div class="y">
            ...
            <a href="4.php" class="yy">Популярное</a>
        </div>
    </div>
    <script>
