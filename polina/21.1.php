...
<div class="rrt">
    <p class="tyty">Книги по психологии</p>
    <ol>
        <li>К себе нежно</li>
        <p>Ольга Примаченко</p>
        <a href="30.html" class="opi" onclick="showNotification(event)">Читать</a>
        <br>
        <li>Теория невероятности</li>
        <p>Татьяна Мужицкая</p>
        <a href="31.html" class="opi" onclick="showNotification(event)">Читать</a>
    </ol>
    <br>
</div>
